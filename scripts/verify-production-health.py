...
def run_checks():
    ...
    check("borrarClase presente con reembolso", "async function borrarClase(id)" in p_html and "saldo_gratis_descontado" in p_html)
    ...
    with open("clases.html", "r", encoding="utf-8") as f:
        cls_html = f.read()
    check("WhatsApp configurado en index.html", "https://wa.me/34624454212" in idx_html)
    check("WhatsApp configurado en clases.html", "https://wa.me/34624454212" in cls_html)
    check("WhatsApp configurado en tarifas.html", "https://wa.me/34624454212" in tar_html)
