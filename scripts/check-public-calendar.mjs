...
assert.match(classesPage, /public-calendar\.css\?v=6\.10/);
assert.match(classesPage, /public-calendar\.js\?v=6\.10/);
assert.match(classesPage, /facilities-carousel\.js\?v=6\.10/);
