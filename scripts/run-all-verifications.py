...
def run():
    ...
    check("3.6 Borrado seguro de clases con reembolso de bonos a alumnos", "async function borrarClase(id)" in p_html and "saldo_gratis_descontado" in p_html)
    ...
    check("6.1 Enlace directo de WhatsApp en index.html", "https://wa.me/34624454212" in idx_html)
    check("6.2 Enlace directo de WhatsApp en clases.html", "https://wa.me/34624454212" in cls_html)
    check("6.3 Enlace directo de WhatsApp en tarifas.html", "https://wa.me/34624454212" in tar_html)
    check("6.4 Teléfono de contacto correcto (+34 624 45 42 12)", "+34 624 45 42 12" in idx_html or "624 45 42 12" in idx_html)
