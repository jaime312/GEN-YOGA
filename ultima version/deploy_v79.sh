...
echo "🚀 Desplegando GEN Yoga v7.9 a GitHub y Producción..."
...
echo "1. Copiando ficheros actualizados v7.9..."
...
echo "2. Añadiendo cambios y haciendo commit v7.9..."
...
git commit -m "feat(v7.9): logica universal de reservas: clases gratuitas reservables con bono gratis o normal, clases regulares solo con bono normal"

echo "3. Pushing a origin main..."
git push origin main

echo ""
echo "🎉 ¡Despliegue de la versión 7.9 completado con éxito en GitHub y Producción!"
