...
echo "🚀 Desplegando GEN Yoga v7.6 a GitHub y Producción..."
...
echo "1. Copiando ficheros actualizados v7.6..."
...
echo "2. Añadiendo cambios y haciendo commit..."
...
git commit -m "feat(v7.6): version 7.6 en produccion, sesiones angel y yanira abiertas, borrado con reembolso y fallback total"

echo "3. Pushing a origin main..."
git push origin main

echo ""
echo "🎉 ¡Despliegue de la versión 7.6 completado con éxito en GitHub y Producción!"
