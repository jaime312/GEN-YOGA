-- ==============================================================================
-- Migración 202609020075: Bono Ilimitado con Acceso Ilimitado a Clases Normales
-- GEN YOGA v9.14
-- ==============================================================================

BEGIN;

-- 1. Normalizar periodos en unlimited_membership_periods para garantizar mes natural completo
...
-- 2. Asegurar que usuarios con bono_mensual_activo en profiles tengan su registro en unlimited_membership_periods
...
-- 3. Función RPC de administrador: Asignar o revocar mes natural de Bono Ilimitado
...
-- 4. Mantener compatibilidad total con admin_configurar_bono_mensual
...
-- 5. Función central reservar_con_bono: Permite reservar todas las clases normales deseadas con Bono Ilimitado
...
BEGIN
  ...
  -- Prioridad 4: Bono Ilimitado por Mes Natural (permite todas las clases normales deseadas)
  ...
  IF v_use_unlimited THEN
    ...
    -- Para clases normales: RESERVA ILIMITADA sin límite de 8 ni semanal
    INSERT INTO public.reservas_yoga (
      clase_id, user_id, estado, usado_bono_mensual, bono_descontado,
      class_pack_id, saldo_gratis_descontado, welcome_companion_modality
    ) VALUES (
...
-- 6. Sobrecarga de compatibilidad reservar_con_bono(bigint, uuid)
CREATE OR REPLACE FUNCTION public.reservar_con_bono(
  p_clase_id bigint,
  p_user_id uuid
)
