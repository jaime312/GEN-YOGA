...
echo "🚀 Desplegando GEN Yoga v7.8 a GitHub y Producción..."
...
echo "1. Copiando ficheros actualizados v7.8..."
...
echo "2. Añadiendo cambios y haciendo commit v7.8..."
...
git commit -m "feat(v7.8): restaurar estructura 3 fichas de ofertas en tarifas (Bono Bienvenida, Sesiones Introductorias, Yoga en Compania) y version 7.8"

echo "3. Pushing a origin main..."
git push origin main

echo ""
echo "🎉 ¡Despliegue de la versión 7.8 completado con éxito en GitHub y Producción!"
