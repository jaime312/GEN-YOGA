-- ==============================================================================
-- Migración 202609070001: Detalle exacto de método de pago en asistencias (v12.16)
-- Descripción:
--   Extiende public.admin_obtener_asistencias_completas para retornar:
--   - tipo_reserva (e.g. 'pack_normal', 'clase_suelta', 'ilimitado', 'taller', 'reprogramacion_taller', 'compania')
--   - parent_reserva_id
--   - nombre_acompanante
--   Garantiza que la administración y el profesorado identifiquen sin ambigüedad
--   el método de pago exacto utilizado por cada cliente.
-- ==============================================================================
...
BEGIN
  ...
  SELECT
    ...
    r.tipo_reserva::text AS tipo_reserva,
    r.parent_reserva_id,
    r.nombre_acompanante::text AS nombre_acompanante
  ...
  SELECT
    ...
    coalesce(r.tipo_reserva::text, 'consulta') AS tipo_reserva,
